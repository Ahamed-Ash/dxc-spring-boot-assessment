...
import com.dxc.authorrestapi.services.AuthorService;
import com.dxc.authorrestapi.dto.AuthorDto;
import com.dxc.authorrestapi.model.Author;
import com.dxc.authorrestapi.controller.AuthorNotFoundException;
...
public class AuthorController {
    ...
    @GetMapping("/author")
    public ResponseEntity<List<Author>> findAllPeople(){
        List<Author> authors=authorService.findAllPeople();
